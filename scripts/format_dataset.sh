...
SCENE_PATH=/ubc/cs/research/kmyi/matthew/backup_copy/raw_real_ednerf_data/work_dir/boardroom_b2_v1                  # [REQUIRED] path/scene
TARG_DIR=/ubc/cs/research/kmyi/matthew/projects/ed-nerf/data/boardroom_b2_v1          # [REQUIRED] path to location to save the formatted dataset
